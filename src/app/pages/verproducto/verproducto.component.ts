...
@Component({
  ...
  styleUrls: ['./verproducto.component.sass']
})
export class VerproductoComponent implements OnInit {
  ...
  constructor(
    ...
    this.formu.controls['nombre'].disable();
    this.formu.controls['slug'].disable();
    this.formu.controls['descripcion'].disable();
    this.formu.controls['categoria_id'].disable();
    this.formu.controls['precio'].disable();
